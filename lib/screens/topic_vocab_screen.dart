...
class _TopicVocabScreenState extends State<TopicVocabScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(trf('Day별 필수 단어 · {0}단어', [total]),
                style: const TextStyle(
      ...
      body: _loading
          ? const Center(
              child: CircularProgressIndicator(color: AppColors.beni))
          : GridView.builder(
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: AppColors.beni.withValues(alpha: 0.6)),
                    ),
                    child: Column(
          ...
          IconButton(
            ...
            icon: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: _mode == StudyMode.all
                    ? null
                    : AppColors.beni.withValues(alpha: 0.08),
              ),
              child: Text(
                _modeLabel,
                style: TextStyle(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: memorized && study
                  ? AppColors.kin.withValues(alpha: 0.10)
                  : AppColors.washi,
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                color: memorized && study
                    ? AppColors.beni.withValues(alpha: 0.7)
                    : AppColors.kin.withValues(alpha: 0.8),
              ),
            ),
            child: Stack(
              children: [
                Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (word.rd.isNotEmpty && !hideTx && word.rd != word.tx)
                        Text(
                          word.rd,
                          maxLines: 1,
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      icon: Icon(
                        ...
                        color: memorized
                            ? AppColors.beni
                            : AppColors.sumiLight.withValues(alpha: 0.6),
                      ),
                    ),
                  ),
              ],
      ...
      builder: (context, _, _) {
        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: memorized && study
                  ? AppColors.kin.withValues(alpha: 0.08)
                  : null,
              border: Border(
                top: BorderSide(
                    color: AppColors.kin.withValues(alpha: 0.35)),
              ),
            ),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.w800,
                          color:
                              hideTx ? AppColors.sumiLight : AppColors.sumi,
                          height: 1.3,
                        ),
                      ),
                      const SizedBox(height: 2),
