...
class MemoToggle extends StatefulWidget {
  ...
  final Color? foreground; // 어두운 버블 위에 놓일 때 글자색
...
class _MemoToggleState extends State<MemoToggle> {
  ...
  Widget build(BuildContext context) {
    ...
    final accent = fg ?? AppColors.beni;
    final muted = fg?.withValues(alpha: 0.7) ?? AppColors.sumiLight;
    return Column(
